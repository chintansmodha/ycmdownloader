...
def partytotalprint(d,stdt,etdt):
    ...
    c.drawString(10,d,"Party Total :")
    c.drawAlignedString(235,(d),str(round(TotalPartyQty,3)))
    c.drawAlignedString(295,(d),str(round(TotalPartyAmt,2)))
    TotalPartyQty=0
    TotalPartyAmt=0
...
def printDespatchTotal(d,stdt,etdt):
    ...
    c.drawAlignedString(235,(d),str(round(TotalDespatchQty,3)))
    c.drawAlignedString(295,(d),str(round(TotalDespatchAmt,2)))
    TotalDespatchQty=0
    TotalDespatchAmt=0
