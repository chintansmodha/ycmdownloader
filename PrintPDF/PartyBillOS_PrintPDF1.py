...
def header(stdt,etdt,divisioncode,agentgroup):
    ...
    fonts(8)
    c.drawCentredString(450, 560, "Party Bill OutStanding Credit Summary Yes From " + stdt.strftime('%d-%m-%Y') + " To " + etdt.strftime('%d-%m-%Y'))
    ...
    c.drawString(10, 525, "Invoice No.")
    c.drawString(80, 525, "Invoice Date")
    c.drawString(160, 525, "L.R. No.")
    c.drawString(220, 525, "Item Name")
    c.drawString(470, 525, "Transporter")
    c.drawString(620, 525, "Quantity")
