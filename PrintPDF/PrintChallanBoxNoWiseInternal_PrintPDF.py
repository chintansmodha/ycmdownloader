...
def header(result):
    global unit
    fonts(15)
    c.drawCentredString(305, 385, result['PLANTNAME'])
    fonts(8)
    c.drawCentredString(300, 370, result['PLANTADDRESS'])
    fonts(9)
    # c.drawString(25, 328,  str(result['CUSTOMER']))
    # customeraddress=result['CUST_ADDR1']
    ca=316
    ...
    # consigeeaddress = result['CONSIGNEE_ADDR1']
    # ca = ca-24
