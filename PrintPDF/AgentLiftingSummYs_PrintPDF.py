...
def header(stdt,etdt, divisioncode):
    ...
    c.drawCentredString(300, 780, "Agent Wise Lifting Party Wise Summary From  " + str(stdt.strftime(' %d  %b  %Y')) +
...
def newrequest():
    ...
    global brokergroupAmt, brokergroupQnt, grandbrokergroupQnt, grandbrokergroupAmt
    divisioncode = []
    Party = []
    Broker  = []
    Item = []
