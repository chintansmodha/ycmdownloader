...
from PrintPDF import SupplierWise_Summary_PrintPDF as pdfrpt
from Global_Files import Connection_String as con
from datetime import datetime
counter=0
def SupplierWise_Summary_PrintPDF(LSDepartment, LSSupplier, LSItemType, LSItems, LDStartDate, LDEndDate, LCDepartment,LCSupplier, LCItemType, LCItem, LSFileName, LSReportType):
    ...
    sql = "select DIVISION.LONGDESCRIPTION AS DIVCODE," \
          ...
          "order by DIVISION.LONGDESCRIPTION,COSTCENTER.LONGDESCRIPTION,BUSINESSPARTNER.LEGALNAME1,PRODUCT.LONGDESCRIPTION"
    ...
    if result == False:
        if counter > 0:
            ...
            pdfrpt.fonts(7)
            #pdfrpt.printitemtotal()
            #pdfrpt.d = pdfrpt.dvalue(stdt, etdt, pdfrpt.divisioncode)
            pdfrpt.printsuppliertotallast()
            #pdfrpt.d = pdfrpt.dvalue(stdt, etdt, pdfrpt.divisioncode)
