...
from PrintPDF import SupplierWise_Details_PrintPDF as pdfrpt
from Global_Files import Connection_String as con
from datetime import datetime
counter=0
def SupplierWise_Details_PrintPDF(LSDepartment, LSSupplier, LSItemType, LSItems, LDStartDate, LDEndDate, LCDepartment,LCSupplier, LCItemType, LCItem, LSFileName, LSReportType):
    ...
    sql = "select DIVISION.LONGDESCRIPTION AS DIVCODE,MRNHEADER.CODE AS MRNNO,MRNHEADER.MRNDATE AS MRNDATE," \
          ...
          "order by DIVISION.LONGDESCRIPTION,COSTCENTER.LONGDESCRIPTION,BUSINESSPARTNER.LEGALNAME1,PRODUCT.LONGDESCRIPTION,MRNHEADER.CODE,MRNHEADER.MRNDATE Desc"
