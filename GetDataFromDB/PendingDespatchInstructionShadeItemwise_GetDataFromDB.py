...
def PendingDespatchInstructionShadeItemWise_PrintPDF(LSCompanyUnitCode, LSParty, LDstdt, LDEndDate, LCParty, LCCompanyCode, LSDocumentType,
    ...
    sql ="Select  Division.LongDescription As BUSINESSUNITName" \
         ...
         "order by Division.LongDescription,ShadeName, ordDate, ordNo "
    ...
    while result != False:
        ...
        pdfPDISIW.textsize(pdfPDISIW.c, result, pdfPDISIW.d,stdt,etdt,LCRemarks)
        pdfPDISIW.d=pdfPDISIW.dvalue()
        result = con.db.fetch_both(stmt)

        if LCRemarks == ['1']:
            if pdfPDISIW.d<65 :
                pdfPDISIW.d=740
                #pdfPDISIW.c.setPageSize(pdfPDISIW.landscape(pdfPDISIW.A3))
                pdfPDISIW.c.showPage()
                pdfPDISIW.header(stdt,etdt,pdfPDISIW.divisioncode)
                pdfPDISIW.fonts(8)
        else:
            if pdfPDISIW.d<50 :
                pdfPDISIW.d=745
    ...
    if result == False:
        if counter > 0:
            ...
            if LCRemarks == ['1']:
                if pdfPDISIW.Remark == '':
                    pdfPDISIW.c.drawString(19, pdfPDISIW.d, "Remarks :")
                else:
                    pdfPDISIW.c.drawString(19, pdfPDISIW.d, pdfPDISIW.Remark)
                pdfPDISIW.d = pdfPDISIW.dvalue()
            pdfPDISIW.c.drawAlignedString(350, pdfPDISIW.d, "Item Total : ")
            pdfPDISIW.c.drawAlignedString(500, pdfPDISIW.d, str(pdfPDISIW.format_number(float(pdfPDISIW.Item_Total), locale='en_IN')))
            pdfPDISIW.c.drawAlignedString(545, pdfPDISIW.d, str(pdfPDISIW.format_number(float(pdfPDISIW.ItemBalQty_Total), locale='en_IN')))
            pdfPDISIW.d = pdfPDISIW.dvalue()
            pdfPDISIW.c.drawAlignedString(350, pdfPDISIW.d, "Shade Total : ")
            pdfPDISIW.c.drawAlignedString(500, pdfPDISIW.d, str(pdfPDISIW.format_number(float(pdfPDISIW.Shade_Total), locale='en_IN')))
            pdfPDISIW.c.drawAlignedString(545, pdfPDISIW.d, str(pdfPDISIW.format_number(float(pdfPDISIW.ShadeBalQty_Total), locale='en_IN')))
            pdfPDISIW.d = pdfPDISIW.dvalue()
            pdfPDISIW.c.drawAlignedString(350, pdfPDISIW.d, "Grand Total : ")
            pdfPDISIW.c.drawAlignedString(500, pdfPDISIW.d,str(pdfPDISIW.format_number(float(pdfPDISIW.Grand_Total), locale='en_IN')))
            pdfPDISIW.c.drawAlignedString(545, pdfPDISIW.d, str(pdfPDISIW.format_number(float(pdfPDISIW.GrandBal_Total), locale='en_IN')))
    ...
    # os.startfile(url)
    pdfPDISIW.newrequest()
    pdfPDISIW.d = pdfPDISIW.newpage()