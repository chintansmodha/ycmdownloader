from PrintPDF import PurchaseRegister_ItemSummary_PrintPDF as pdfrpt
from Global_Files import Connection_String as con
import os
from datetime import datetime
from ProcessSelection import PurchaseRegister_ProcessSelection as PRV
counter=0
def PurchaseRegister_ItemSummary_PrintPDF(LSCompanyUnitCode, LSItemTypeCode, LDStartDate, LDEndDate, LSFileName,  LCItemTypeCode, LCCompanyCode, LSReportType):
    ...
    sql = "Select DIVISION.LONGDESCRIPTION AS DIVCODE" \
       ...
       " ORDER BY DIVISION.LONGDESCRIPTION,PRODUCT.LONGDESCRIPTION"
    ...
    pdfrpt.c.showPage()
    pdfrpt.c.save()
    # url="file:///D:/Report Development/Generated Reports/Purchase Register - Item Summary/"+LSFileName+".pdf"
    # os.startfile(url)
    pdfrpt.newrequest()
