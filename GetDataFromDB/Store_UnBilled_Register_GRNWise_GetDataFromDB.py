...
from PrintPDF import Store_UnBilled_Register_GRNWise_PrintPDF as pdfrpt
...
def StoreRegisterGRNWisePrintPDF(LSallPlant, LSallSupplier, LSallItem, LSPlant, LSSupplier, LSItem, LDStartDate,
    ...
    if allsupplier == 'None' and len(LSSupplier) != 0:
        ...
        sqlwhere += ' AND BusinessPartner.NUMBERID IN ' + LSSupplier + ''
    ...
    if allitem == 'None' and len(LSItem) != 0:
        ...
        sqlwhere += ' AND PRODUCTIE.ITEMTYPECODE IN ' + LSItem + ''
    ...
    sql += sqlwhere + " ORDER BY PlantName, MRNCODE"
