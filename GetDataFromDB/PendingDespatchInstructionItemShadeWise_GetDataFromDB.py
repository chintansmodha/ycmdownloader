...
def PendingDespatchInstructionItemShade_PrintPDF(LSCompanyUnitCode, LSParty, LDstdt, LDEndDate, LCParty, LCCompanyCode, LSDocumentType,
    ...
    sql ="Select  Division.LongDescription As BUSINESSUNITName" \
         ...
         "order by Division.LongDescription, ProductName,ordDate, ordNo"
    ...
    while result != False:
        ...
        pdfPDIISW.textsize(pdfPDIISW.c, result, pdfPDIISW.d,stdt,etdt,LCRemarks)
        pdfPDIISW.d=pdfPDIISW.dvalue()
        result = con.db.fetch_both(stmt)

        if LCRemarks == ['1']:
            if pdfPDIISW.d<65 :
                pdfPDIISW.d=740
                pdfPDIISW.c.showPage()
                pdfPDIISW.header(stdt,etdt,pdfPDIISW.divisioncode)
                pdfPDIISW.fonts(8)
        else:
            if pdfPDIISW.d<40 :
                pdfPDIISW.d=740
    ...
    if result == False:
        if counter > 0:
            ...
            if LCRemarks == ['1']:
                if pdfPDIISW.Remark == '':
                    pdfPDIISW.c.drawString(19, pdfPDIISW.d, "Remarks :")
                else:
                    pdfPDIISW.c.drawString(19, pdfPDIISW.d, pdfPDIISW.Remark)
                pdfPDIISW.dvalue()
            pdfPDIISW.c.drawAlignedString(350, pdfPDIISW.d, "Shade Total: ")
            pdfPDIISW.c.drawAlignedString(500, pdfPDIISW.d, str(pdfPDIISW.format_number(float(pdfPDIISW.Shade_Total), locale='en_IN')))
            pdfPDIISW.c.drawAlignedString(540, pdfPDIISW.d, str(pdfPDIISW.format_number(float(pdfPDIISW.ShadeBalQty_Total), locale='en_IN')))
            pdfPDIISW.d = pdfPDIISW.dvalue()
            pdfPDIISW.c.drawAlignedString(350, pdfPDIISW.d, "Item Total: ")
            pdfPDIISW.c.drawAlignedString(500, pdfPDIISW.d, str(pdfPDIISW.format_number(float(pdfPDIISW.Item_Total), locale='en_IN')))
            pdfPDIISW.c.drawAlignedString(540, pdfPDIISW.d, str(pdfPDIISW.format_number(float(pdfPDIISW.ItemBalQty_Total), locale='en_IN')))
            pdfPDIISW.d = pdfPDIISW.dvalue()
            pdfPDIISW.c.drawAlignedString(350, pdfPDIISW.d, "Grand Total: ")
            pdfPDIISW.c.drawAlignedString(500, pdfPDIISW.d,str(pdfPDIISW.format_number(float(pdfPDIISW.Grand_Total), locale='en_IN')))
            pdfPDIISW.c.drawAlignedString(540, pdfPDIISW.d, str(pdfPDIISW.format_number(float(pdfPDIISW.GrandBal_Total), locale='en_IN')))
            ...
            return
    #pdfPDIISW.workbook.close()
    # pdfPDIISW.c.setPageSize(pdfPDIISW.landscape(pdfPDIISW.A3))

    pdfPDIISW.c.showPage()
    pdfPDIISW.c.save()
    # url = "file:///D:/Report Development/Generated Reports/GST Register/" + LSFileName + ".pdf"
    # os.startfile(url)
    pdfPDIISW.newrequest()
    pdfPDIISW.d = pdfPDIISW.newpage()