...
def xmlheader(stdt, etdt):
    ...
    worksheet.merge_range(str('A'+ str(row+3) +':' + 'P' + str(row+3)), 'Broker Wise RD (Only RD Invoices)  Report  ' + str(stdt.strftime("%d - %b - %Y")) + '  From  ' + str(etdt.strftime("%d - %b - %Y")), sub_header_row)
