...
def PackingRegisterHtml(request):
    return render(request,'PackingRegister.html',{'company':company,'party':party,'lot':lot,'quality':quality,'department':department,'agent':agent,'winding':winding,'shade':shade})
